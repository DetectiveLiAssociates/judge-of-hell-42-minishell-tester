...
- Judge of Hell only test input parameters; and doesn't test your minishell History, the Sorted ENV Variables, *norminette*-dressings, CTRL-C, CTRL-D, and CTRL-\ hardware-based input prerequisites - those which must be tested manually on your own.
